...
void player_reset_test(player_t *player, parser_t *parser)
{
    ...
    player->wrong_input = malloc(sizeof(char) * (strlen(parser->sentence) + 1));
    player->correct_input = malloc(sizeof(char) * (strlen(parser->sentence) + 1));
    player->wrong_input = memset(player->wrong_input, 0, strlen(parser->sentence));
    player->correct_input = memset(player->correct_input, 0, strlen(parser->sentence));
}
